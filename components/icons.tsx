...
// Online-Bestand: noch verlinkt ↔ rausgeflogen
export const Link2 = (p: P) => <S {...p}><path d="M9 17H7A5 5 0 0 1 7 7h2" /><path d="M15 7h2a5 5 0 0 1 0 10h-2" /><path d="M8 12h8" /></S>;
export const Link2Off = (p: P) => <S {...p}><path d="M9 17H7A5 5 0 0 1 7 7h2" /><path d="M15 7h2a5 5 0 0 1 4.9 6" /><path d="M8 12h3" /><path d="m2 2 20 20" /></S>;
