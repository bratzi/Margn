...
export default function ScrollSpine() {
  // Nur Desktop: auf Mobile ist die Linie störend (User-Entscheid 12.07.) — dort gar nicht
  // erst rendern (spart Scroll-Listener/RAF); CSS blendet zusätzlich sofort aus (kein Flash).
